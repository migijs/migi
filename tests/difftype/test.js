...
module.exports = {
  ...
  '[text,dom]2[dom,dom]': function(browser) {
    browser
      ...
      .assert.containsText('#test li[title="DOM+变量+DOM"]', 'domdomdomdomdom')
      .assert.containsText('#test li[title="DOM+变量+DOM+变量"]', 'domdomdomdomdomdomdomdom')
      .assert.containsText('#test li[title="变量+DOM+变量+DOM"]', 'domdomdomdomdomdomdomdom')
