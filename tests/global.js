...
seajs.config({
  alias: {
    'homunculus': seajs.resolve('../node_modules/lefty/node_modules/homunculus/index.js', seajs.data.base),
    'jsdc': seajs.resolve('../node_modules/jsdc/index.js', seajs.data.base),
    'lefty': seajs.resolve('../node_modules/lefty/init.js', seajs.data.base),
    'jaw': seajs.resolve('../node_modules/jaw/init.js', seajs.data.base),
    'migi': seajs.resolve('../init.js', seajs.data.base)
  }
});
define('fs', {});