...
module.exports = {
  ...
  'ttt2ddd': function(browser) {
    browser
      .click('#test strong')
      .assert.containsText('#test p[ref="1"]', '3')
      .assert.containsText('#test p[ref="2"]', '<span migi-uid="15">1</span><span migi-uid="16">2</span><span migi-uid="17">3</span>')
  },
  ...
  'tdd2ddd': function(browser) {
    browser
      .click('#test strong')
      .assert.containsText('#test p[ref="1"]', '3')
      .assert.containsText('#test p[ref="2"]', '<span migi-uid="20">1</span><span migi-uid="16">2</span><span migi-uid="17">3</span>')
  },
  ...
  'dtd2ddd': function(browser) {
    browser
      .click('#test strong')
      .assert.containsText('#test p[ref="1"]', '3')
      .assert.containsText('#test p[ref="2"]', '<span migi-uid="20">1</span><span migi-uid="26">2</span><span migi-uid="17">3</span>')
  },
  ...
  'ddt2ddd': function(browser) {
    browser
      .click('#test strong')
      .assert.containsText('#test p[ref="1"]', '3')
      .assert.containsText('#test p[ref="2"]', '<span migi-uid="20">1</span><span migi-uid="26">2</span><span migi-uid="32">3</span>')
  },
  ...
  'ttd2ddd': function(browser) {
    browser
      .click('#test strong')
      .assert.containsText('#test p[ref="1"]', '3')
      .assert.containsText('#test p[ref="2"]', '<span migi-uid="34">1</span><span migi-uid="35">2</span><span migi-uid="32">3</span>')
  },
  ...
  'dtt2ddd': function(browser) {
    browser
      .click('#test strong')
      .assert.containsText('#test p[ref="1"]', '3')
      .assert.containsText('#test p[ref="2"]', '<span migi-uid="34">1</span><span migi-uid="39">2</span><span migi-uid="40">3</span>')
  },
  ...
  'tdt2ddd': function(browser) {
    browser
      .click('#test strong')
      .assert.containsText('#test p[ref="1"]', '3')
      .assert.containsText('#test p[ref="2"]', '<span migi-uid="42">1</span><span migi-uid="39">2</span><span migi-uid="44">3</span>')
      .end()
  }
};