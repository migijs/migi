...
var Stream=function(){var _4=require('./Stream');return _4.hasOwnProperty("default")?_4["default"]:_4}();

!function(){var _5=Object.create(Component.prototype);_5.constructor=CachedComponent;CachedComponent.prototype=_5}();
  ...
  CachedComponent.prototype.__bridgeData = function(k) {
    ...
    if(!self.__bcb) {
      ...
      setTimeout(function() {
        ...
        keys = keys.length > 1 ? keys : keys[0];
        Component.prototype.__onData.call(_7,keys);
        //fake来源，来自于桥接bridge
